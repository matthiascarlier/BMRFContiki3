...
declare -a ENGINECONF=('BMRF');
declare -a MODECONF=('UNICAST');
declare -a THRESHOLDCONF=(  '1');

declare -a RANDOMTOPOLOGIES=('random_topology_A' 'random_topology_B' 'random_topology_C' 'random_topology_D' 'random_topology_E')
